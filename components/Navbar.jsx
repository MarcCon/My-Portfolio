...
const Navbar = () => {
  return (
    <>
      <nav className="z-50 sticky left-0 top-0 flex w-full items-center justify-between bg-black 2xl:p-8 sm:p-6 p-4 text-base font-bold text-white sm:px-16 sm:text-xl">
        <Link href="/">
